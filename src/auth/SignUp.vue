  ...
  <body class="h-screen">
    <div class="flex justify-center items-center min-h-screen">
      <div class="wrapper text-gray-800">
        <!-- Updated wrapper background and text color -->
        <form>
          <h1 class="title text-3xl mb-8 font-bold">BIT INVENTORY</h1>
          ...
          <div
            @click="handleSignIn"
            type="button"
            class="input-box bg-sandy button-hover hover:text-white hover:shadow-lg font-bold py-2 px-4 rounded-full flex items-center justify-center transition duration-300 ease-in-out"
          >
            <img
...
.wrapper {
  ...
  border-radius: 12px;
  padding: 30px 40px;
  border: 3px solid #7e57c2; /* Updated border color to match the gradient */
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Subtle shadow for depth */
  transition: transform 0.3s ease-in-out; /* Smooth transition for hover effect */
  background-color: #eee5f9; /* Set the wrapper background color to match the body background color */
}
...
.bg-sandy {
  background-color: #cdc1ff; /* Set the button background color to sandy */
  color: #333; /* Set the button text color to a suitable dark color */
}

.button-hover:hover {
  background-color: #a294f9; /* Lighten the button background color on hover */
}
